...
\usepackage{cleveref}
\usepackage{float}
\title{\vspace{-2cm}Reproducing a Tuning-Free Plug-and-Play algorithm for Sparse-View CT \\[0.5cm]
...
% ---- WORD COUNT ON FRONT COVER (required by the course policy) ----
\begin{center}
{\small Word count: \textbf{[INSERT FINAL COUNT]} (excluding references)}
\end{center}
\vspace{0.3cm}
