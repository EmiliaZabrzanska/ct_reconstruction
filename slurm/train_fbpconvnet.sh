...
#SBATCH -o logs/fbpconvnet_%j.out
#SBATCH -e logs/fbpconvnet_%j.err

source ~/.bashrc
conda activate mphil_ct
cd ~/rds/hpc-work/eaz21

EXPERIMENT_NAME="fbpconvnet_pat_250_e80"
...
echo "Config:     250 train × 80 epochs (FBPConvNet, run_04 budget)"
echo "Start:      $(date)"
echo "================================================="
